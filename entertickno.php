...
<form class="box-2" action="ticket.php" method="post"> 
<div class="project1-group">
<h2><p><i>Please Enter Your Ticket Number</i></p></h2><br>
Ticket Number : <input type="text" name="ticketno"><br>
<h2><p><i>Please Enter Your Passenger ID</i></p></h2><br>
Passenger ID : <input type="text" name="passID"><br> 
</div>  
