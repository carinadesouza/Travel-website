...
echo "<h1 style='color:rgb(68,24,0);'>Your Ticket Has Been Booked !!</h1>";
echo "<br><h4 style=color:rgb(68,24,0);'>Passenger ID = ".$passid."</h4>";
echo "<br><h4 style='color:rgb(68,24,0);'>Ticket Number =" .$tickno."</h4>";
echo "<br><h4 style='color:rgb(68,24,0);'>Click View to see Passenger and Flight Details</h4>";
echo "<h4><a href='entertickno.php' style='color:rgb(68,24,0);'>View</h4></a>"; ?> 
</div> 
      </body>
      </html>
