...
<header>
  ...
  <form class="box-2"action="GDC-RailwayHomeConn.php" method="post">
    <h1>Railway Booking</h1>
    <br>
    <div class="project1-group">
      <label>Boarding Station:</label>
      <select name="board" id="ori">
        <option value="board">select option</option>
      ...
      <select name="desti"id="dest">
        <option value="desti">select option</option>
        <option value="Margao">Margao</option>
        <option value="Mumbai">Mumbai</option>
        <option value="Mangalore">Mangalore</option>
        <option value="Surat">Surat</option>
    ...
    <input type="date" name="trainDate"id="depart"> 
</div>
    <br>
    <label>Class:</label>
