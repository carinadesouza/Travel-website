...
<div class ="box-2">
    <h1><p style="color:white">Whatatrip Airways - Ticket</h1></p>
    
	<div class="container">
		<table id="tabtk" width="600"  cellspacing="2" style ="color:rgb(68,24,0);border-radius:5px;">
			<thead>
        <br>  <h3><p style="color:white">Passenger Details and Flight Details</p></h3>
				<tr>
					<th>Ticket Number</th>
					<th>Flight Number</th>
                    <th>Class</th>
				...
				<?php
					...
					if(isset($_POST['Submit'])){
						...
						if(mysqli_query($conn,$sql))
						{
							...
							echo "<a href='enterflightno.php' style='margin-left:200px;margin-top:100px;text-decoration:none;color:white;'>View</a>";
						}
						else
						{
							echo "Something Went Wrong";
