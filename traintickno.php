...
<form class="box-2" action="trainticket.php" method="post"> 
<div class="project1-group">
<h2><p>Please Enter Your Train Ticket Number</p></h2><br>
Ticket Number : <input type="text" name="ticketno"><br>
<h2><p>Please Enter Your Passenger ID</p><br>
Passenger ID : <input type="text" name="passID"><br> </div> 
